 ...
 * @author David
 */
public class Actualizar_Estudiante extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (boton.equals("Cargar")) {
                ...
                if (dos.getId_Estudiante() != 0) {
                    ...
                    out.println(docType4
                            ...
                            + "</head>\n"
                            + "<body>\n"
                            + "<form method=\"post\" action=\"Actualizar_Estudiante\"\n"
                            ...
                            + "      </tr>\n"
                            + "      <tr>\n"
                            + "        <td>Id Habitacion:<input name=\"idhabi\"></td>\n"
                            + "      </tr>\n"
                            + "      <tr>\n"
                            ...
                            + "      </tr>\n"
                            + "      <tr>\n"
                            + "        <td>Universidad:<input name=\"universidad\"></td>\n"
                            + "      </tr>" + "      <tr align=\"center\">\n"
            ...
            if (boton.equals("Actualizar")) {
                ...
                String idhabiidencias = request.getParameter("idhabi");
                ...
                bd.conectar();
                System.out.println(idestud + idhabiidencias);
                s = bd.actualizar(Integer.valueOf(idestud), Integer.valueOf(idhabiidencias), nombre,Integer.valueOf(telefono), Integer.valueOf(edad), carrera, uni);
                bd.desconectar();
