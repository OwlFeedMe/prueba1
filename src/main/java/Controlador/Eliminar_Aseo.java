 ...
 * @author David
 */
public class Eliminar_Aseo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Datos_Basico_Aseo db = new Datos_Basico_Aseo();
            ...
            if (boton.equals("Cargar")) {
                ...
                if (dos.getId() != 0) {
                    ...
                    out.println(docType4
                            ...
                            + "</head>\n"
                            + "<body>\n"
                            + "<form method=\"post\" action=\"Eliminar_Aseo\"\n"
                            + " name=\"Eliminar_Aseo\">\n"
                ...
                if (boton.equals("Eliminar")) {
                    ...
                    bd.conectar();
                   s= bd.eliminar(Integer.valueOf(idaseos), Integer.valueOf(idresidencias));
                    bd.desconectar();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(Eliminar_Aseo.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
