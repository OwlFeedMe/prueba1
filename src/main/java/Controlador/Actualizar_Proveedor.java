 ...
 * @author David
 */
public class Actualizar_Proveedor extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (boton.equals("Cargar")) {
                ...
                if (dos.getId() != 0) {
                    ...
                    out.println(docType4
                            ...
                            + "</head>\n"
                            + "<body>\n"
                            + "<form method=\"post\" action=\"Actualizar_Proveedor\"\n"
            ...
            if (boton.equals("Actualizar")) {
                ...
                bd.conectar();
                s = bd.actualizar(Integer.valueOf(iDproveedor), nombre, tipo_proveedor, Integer.valueOf(telefono));
                bd.desconectar();
            }
            if (s == 1) {
                ...
                out.println(docType4
                        ...
                        + "</head>\n"
                        + "<body>\n"
                        + "<form method=\"post\" action=\"Actualizar_Proveedor\" name=\"Actualizar_Proveedor\">\n"
                        + "  <table style=\"text-align: left; width: 100px;\" border=\"1\"\n"
                        + " cellpadding=\"2\" cellspacing=\"2\">\n"
                        + "    <tbody>\n"
                        + "      <tr>\n"
...
// <editor-fold defaultstate="collapsed" desc="HttpServlet methods. Click on the + sign on the left to edit the code.">
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(Actualizar_Proveedor.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
