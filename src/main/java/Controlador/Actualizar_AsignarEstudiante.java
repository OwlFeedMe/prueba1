 ...
 * @author David
 */
public class Actualizar_AsignarEstudiante extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (boton.equals("Cargar")) {
                ...
                if (dos.getId_Asignar_Habitacion() != 0) {
                    ...
                    out.println(docType4
                            ...
                            + "</head>\n"
                            + "<body>\n"
                            + "<form method=\"post\" action=\"Actualizar_AsignarEstudiante\"\n"
                            + " name=\"Actualizar_AsignarEstudiante\">\n"
            ...
            if (boton.equals("Actualizar")) {
                ...
                s = bd.actualizar(Integer.valueOf(idaseos), Integer.valueOf(idestudiaidencias), Integer.valueOf(compania_aseo), fecha_inicio_contrato, fecha_final_contrato);
                bd.desconectar();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(Actualizar_AsignarEstudiante.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
