 ...
 * @author David
 */
public class Eliminar_Habitacion extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (boton.equals("Cargar")) {
                ...
                if (dos.getId_Habitacion() != 0) {
                    ...
                    out.println(docType4
                            ...
                            + "</head>\n"
                            + "<body>\n"
                            + "<form method=\"post\" action=\"Eliminar_Habitacion\"\n"
            ...
            if (boton.equals("Eliminar")) {
                ...
                bd.conectar();
                s = bd.eliminar(Integer.valueOf(idH), Integer.valueOf(idResi));
                bd.desconectar();
            }
            if (s == 1) {
                ...
                out.println(docType4
                        ...
                        + "</head>\n"
                        + "<body>\n"
                        + "<form method=\"post\" action=\"Eliminar_Habitacion\" name=\"Eliminar_Habitacion\">\n"
                        + "  <table style=\"text-align: left; width: 100px;\" border=\"1\"\n"
                        + " cellpadding=\"2\" cellspacing=\"2\">\n"
                        + "    <tbody>\n"
                        + "      <tr>\n"
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(Eliminar_Habitacion.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
